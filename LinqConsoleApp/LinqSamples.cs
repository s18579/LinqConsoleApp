        ...
        */
        ...
        public void Przyklad3()
        {
         ...
         public void Przyklad4()
         {
            ...
            //2. Lambda and Extension methods
            var max2 = Emps.Select(x => new
            {
                Placa = x.Salary
            }).Max(x => x.Placa);
            var res2 = Emps.Where(x => x.Salary == max2).Select(x => new
            {
                Imie_i_Nazwisko = x.Ename,
                Zawod = x.Job,
                Placa = x.Salary
        ...
        {
            //2. Lambda and Extension methods
            var res = Emps.Any(p => p.Job.Equals("Backend programmer"));
            Console.WriteLine(res);
        }
        ...
        {
            //2. Lambda and Extension methods
            var res = Emps.Where(p => p.Job.Equals("Frontend programmer")).OrderByDescending(x => x.HireDate).First();
            Console.WriteLine(res);
        }
        ...
        {
            //2. Lambda and Extension methods
            var res = Emps.Union(new[] { new Emp { Ename = "Brak wartości", Job = null, HireDate = null } }).Select(p => new
            {
                p.Ename,
                p.Job,
                p.HireDate
        ...
        {
            //2. Lambda and Extension methods
            var res = Emps.SelectMany(p => Depts, (p, d) => new
            {
                Emp = p,
                Dept = d
            }).ToList();
